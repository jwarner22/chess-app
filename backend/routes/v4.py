...
@app_v4.get('/opening-stats/{user_id}', tags=["Openings"])
...
@app_v4.post('/openings-data/top-3/{user_id}/{opening_id}', tags=["Openings"])
...
@app_v4.get('/user/{user_id}/opening/{opening_id}/favorites', tags=["Openings"])
...
@app_v4.put('/user/{user_id}/opening/{opening_id}/favorites', tags=["Openings"])
...
@app_v4.get('/opening-data/', response_model=schemas.OpeningData, tags=["Openings"]) # get opening data
...
@app_v4.post('/openings-data/new/{user_id}/{opening_id}', tags=["Openings"]) # add new opening data')
...
# get child openings
@app_v4.post('/openings-data/children', response_model=List[schemas.OpeningData], tags=["Openings"]) # get child openings
...
@app_v4.put('/opening-completions/{user_id}/{opening_id}', tags=["Openings"]) # update opening data for user
...
# get single puzzle 
@app_v4.get('/puzzle/{theme}/{rating}', tags=["Puzzles"])
async def read_puzzle(rating: int, theme: str, limit: int = 10, db: Session = Depends(get_local_db)):
...
# get user profile
@app_v4.get('/users/{user_id}', response_model=schemas.UserProfile, tags=["User"])
...
# get all user data
@app_v4.get('/users/{user_id}/all', response_model=schemas.User, tags=["User"])
...
# update user
@app_v4.put('/users/{user_id}', response_model=schemas.UserProfile, tags=["User"])
...
@app_v4.get('/users/{user_id}/initial-rating')
...
# get theme
@app_v4.get('/users/{user_id}/themes/{theme_title}', response_model=schemas.Theme, tags=["Themes"])
...
# get themes
@app_v4.get('/users/{user_id}/themes', response_model=List[schemas.Theme], tags=["Themes"])
...
# initialize theme
@app_v4.post('/users/{user_id}/themes', response_model=schemas.Theme, tags=["Themes"])
...
# update theme
@app_v4.put("/users/{user_id}/themes", response_model = schemas.Theme, tags=["Themes"])
...
## RATINGS
@app_v4.post("/users/{user_id}/themes/ratings/{rating}", tags=["Ratings"])
...
@app_v4.post("/users/{user_id}/openings/ratings/{rating}", tags=["Ratings"])
...
@app_v4.put('/users/{user_id}/daily_puzzles/picks', response_model=schemas.DailyPicks, tags=["Daily"])
...
@app_v4.get('/users/{user_id}/daily_puzzles', tags=["Daily"])
...
# testing...
@app_v4.get('/users/{user_id}/daily_modules', tags=["Daily"])
...
@app_v4.post('/users/{user_id}/daily_puzzles', tags=["Daily"])
...
@app_v4.put("/users/{user_id}/daily_puzzles", tags=["Daily"])
...
# remove daily puzzle
@app_v4.delete('/users/{user_id}/daily_puzzles', tags=["Daily"])
...
@app_v4.post('/achievements/{user_id}', tags=["Achievements"])
...
@app_v4.get('/achievements/{user_id}', response_model=List[schemas.Achievement], tags=["Achievements"])
...
@app_v4.get('/achievements/{user_id}/daily', response_model=List[schemas.Achievement], tags=["Achievements"])
...
@app_v4.get('/leaderboard/{leaderboard_id}', tags=["Leaderboard"])
...
@app_v4.get('/users/username/{user_name}',tags=["Login"])
...
@app_v4.post('/users/username/{user_id}/{user_name}',tags=["Login"])

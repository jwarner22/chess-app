export const OpeningData = [{
  ...
  id: 47,
  category: "opening",
  headline: "English Opening",
  pawn: "c4",
  moves: "c2c4"
},{
  id: 56,
  category: "opening",
  headline: "Queen's Gambit",
  pawn: "d4",
